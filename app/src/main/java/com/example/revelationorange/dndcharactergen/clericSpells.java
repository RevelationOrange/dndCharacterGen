...
public class clericSpells extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cleric_spells);

        ConstraintSet cset = new ConstraintSet();
        ConstraintLayout spellsConstraint = findViewById(R.id.clericSpellsConstraint);
        ...
        try {
            JSONArray spells0 = DndChar.classDict.getJSONObject("Cleric").getJSONObject("spells").getJSONArray("0");
            JSONArray spells1 = DndChar.classDict.getJSONObject("Cleric").getJSONObject("spells").getJSONArray("1");
            ...
            for (int i = 0; i < n0LvlSpellsPerDay; i++) {
            ...
            prev = headerBox;
            // for y lvl1 spells
            for (int i = 0; i < n1LvlSpellsPerDay; i++) {
                spellSelector = myLib.makeAndrDefDd(this);
