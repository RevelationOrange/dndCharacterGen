...
public class druidSpells extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_druid_spells);
        ConstraintSet cset = new ConstraintSet();
        ConstraintLayout spellsConstraint = findViewById(R.id.druidSpellsConstraint);
        ...
        try {
            JSONArray spells0 = DndChar.classDict.getJSONObject("Druid").getJSONObject("spells").getJSONArray("0");
            JSONArray spells1 = DndChar.classDict.getJSONObject("Druid").getJSONObject("spells").getJSONArray("1");
