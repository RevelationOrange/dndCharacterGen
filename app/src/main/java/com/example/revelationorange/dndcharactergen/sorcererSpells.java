...
public class sorcererSpells extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sorcerer_spells);
        ConstraintSet cset = new ConstraintSet();
        ConstraintLayout spellsConstraint = findViewById(R.id.sorcSpellsConstraint);
        spellsConstraint.setPadding(0,0,0,64*MARGIN_FACTOR);

        int n0SpellsKnown = 4;
        int n1SpellsKnown = 2;
        String lvl0Text = "Level 0", lvl1Text = "Level 1", saveText = "save spells";
        ...
        ((Button) findViewById(R.id.save)).setText(saveText);
        ...
        try {
            JSONArray spells0 = DndChar.classDict.getJSONObject("Sorcerer").getJSONObject("spells").getJSONArray("0");
            JSONArray spells1 = DndChar.classDict.getJSONObject("Sorcerer").getJSONObject("spells").getJSONArray("1");
